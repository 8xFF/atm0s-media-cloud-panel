          ...
          <div className="grid gap-4">
            <Button variant="outline" className="relative w-full">
              <svg
                ...
                className="icon icon-tabler icons-tabler-outline icon-tabler-brand-github absolute left-4"
              >
            ...
            <Button variant="outline" className="relative w-full">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="icon icon-tabler icons-tabler-outline icon-tabler-brand-google absolute left-4"
              >
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
